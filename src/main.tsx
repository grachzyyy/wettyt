...
import App from './App';
import './index.scss'
import './components/NicknameFragment/bootstrap.min.css'
import './components/NicknameFragment/bootstrap-extra.css'
import './components/NicknameFragment/auction.css'
import './components/NicknameFragment/font-roboto.css'
...
async function enableMocking() {
  ...
  return new Promise(async (resolve) => {
    ...
    const startMockWorker = () => worker.start({
      ...
      quiet: false,
      serviceWorker: {
        url: `${import.meta.env.VITE_GH_PAGES ? '' : ''}/mockServiceWorker.js`
      }
    });
